...
*/
const myFirstVehicle = new Vehicle (6, `blue`, 12260);
...
//Code Here
const myFirstMotorcycle = new Motorcycle(2, `orange`, 5000, `BMW`, true);
...
//Code Here
const myFirstBoat = new Boat(5, 'green', 20000, 'Mark 37', 'sailboat', false);
